 ...
 * Central hub that imports and re-exports interactive components from specialized files
 * Eliminates duplicate code and establishes single source of truth for each component
 * Imports design-system.css for token system
 */

// Import specialized components from their dedicated files
...
// ES6 exports - re-export imported components for convenience
export {
  createWordChip,
  createDropContainer,
  createFlippableCard,
